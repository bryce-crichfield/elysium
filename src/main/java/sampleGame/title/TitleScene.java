...
public class TitleScene extends ApplicationScene {
    ...
    container.addChild(
        createMenuButton(
            ...
            () -> {
              ...
              var transition =
                  Transitions.fade(Duration.ofMillis(2000), Color.BLACK, Easing.cubicEaseIn());
    ...
    container.addChild(
        createMenuButton(
            ...
            () -> {
              ...
              game.pushState(
                  OptionsScene::new,
                  Transitions.fade(Duration.ofMillis(300), Color.BLACK, Easing.easeIn()));
            }));
    currentY += BUTTON_HEIGHT + BUTTON_SPACING;
    ...
    container.addChild(
        createMenuButton(
            ...
            () -> {
              ...
              //            this.game.pushState(CreditsState::new,
              // Transitions.fade(Duration.ofMillis(300), Color.BLACK, Easing.easeIn()));
            }));
    currentY += BUTTON_HEIGHT + BUTTON_SPACING;
  ...
  public GuiComponent createMenuButton(int x, int y, String text, Runnable onClick) {
    var button =
        new GuiComponent(x, y, BUTTON_WIDTH, BUTTON_HEIGHT) {
  ...
  public GuiComponent createTitleLabel(int x, int y) {
    var titleLabel =
        new GuiLabel(100, 50, "ECHOES OF ELYSIUM") {
          @Override
          protected void onRender(Renderer g) {
            g.setColor(Color.WHITE);
