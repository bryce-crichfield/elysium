...
public class TileArea {
    ...
    public void drawOutline(Renderer renderer, Color color) {
        for (Tile tile : tiles) {
            ...
            if (!hasBelow) {
                renderer.drawLine(tileX, tileY + Application.TILE_SIZE, tileX + Application.TILE_SIZE, tileY + Application.TILE_SIZE);
            }
            ...
            if (!hasRight) {
                renderer.drawLine(tileX + Application.TILE_SIZE, tileY, tileX + Application.TILE_SIZE, tileY + Application.TILE_SIZE);
            }
        }
    }
