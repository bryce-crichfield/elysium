...
public class TileAnimationComponent implements UpdatableComponent {
    ...
    return new TileAnimationComponent(animationEnabled, animationPeriod, animationX, animationY, animationTargetX, animationTargetY, animationAccumulator, new LinkedList<>(animationPath));
    }
}
