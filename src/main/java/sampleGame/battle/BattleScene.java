...
public class BattleScene extends ApplicationScene {
    ...
    @Getter
    private final GuiContainer gui = new GuiContainer(0, 0, Application.SCREEN_WIDTH, Application.SCREEN_HEIGHT);
    @Getter
...
//        scene = Scene.deserialize("scene1");
        ...
        var transform = Transform.orthographic(0, Application.SCREEN_WIDTH, Application.SCREEN_HEIGHT, 0, -1, 1);
...
//        application.getRuntimeContext().getSystem(NetworkingSystem.class).setHooks(new BattleSceneHooks());
    ...
    public void onKeyPressed(int keycode) {
        ...
        if (keycode == KeyEvent.VK_ESCAPE) {
            application.pushState(TitleScene::new, Transitions.fade(Duration.ofMillis(1000), Color.BLACK, Easing.cubicEaseIn()));
        }
    }
