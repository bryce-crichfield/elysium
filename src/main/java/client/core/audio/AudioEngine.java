...
import client.core.audio.processor.AudioProcessor;
    ...
    while (running) {
      ...
      synchronized (processors) {
        ...
        if (++count >= 10) {
          ...
          //                    System.out.println("Current Active Processors: " +
          // processors.size());
          //                    System.out.println("Average delay processing time: " + averageMs + "
          // ms");
          elapsedNanos = 0;
          count = 0;
        }
