...
import static client.core.graphics.font.FontRenderer.FIRST_CHAR;
import static client.core.graphics.font.FontRenderer.NUM_CHARS;
...
public class FontInfo {
  ...
  public int getStringWidth(String text) {
    ...
    for (int i = 0; i < text.length(); i++) {
      ...
      // Add kerning
      if (i < text.length() - 1) {
        width += STBTruetype.stbtt_GetCodepointKernAdvance(fontInfo, c, text.charAt(i + 1)) * scale;
      }
    }
