...
public class Renderer {
    ...
    @Getter
    private client.core.graphics.paint.Paint paint;
    ...
    private void fillRectWithGradient(int x, int y, int width, int height, client.core.graphics.paint.LinearGradientPaint gradient) {
        pushTransform(Transform.fromScreenSpace(bufferWidth, bufferHeight));
