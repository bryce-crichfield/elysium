...
public class VertexBuffer {
    ...
    public static class Builder {
        ...
        public Builder addAttribute(int count, int type) {
            ...
            attributes.add(new VertexAttribute(currentAttributeIndex++, count, type, attributeSize, stride));
        ...
        public VertexBuffer build(float[] data, int usage) {
            ...
            for (VertexAttribute attr : attributes) {
                ...
                glVertexAttribPointer(attr.getIndex(),     // attribute index
        ...
        public VertexBuffer build() {
            ...
            for (VertexAttribute attr : attributes) {
                ...
                // Configure the attribute pointer
                glVertexAttribPointer(attr.getIndex(), attr.getCount(), attr.getType(), false, stride, attr.getOffset());
            }
