...
public class VectorRenderer {
  ...
  public VectorRenderer() {
    shader =
        new Program(
            "shaders/vector/VectorVertex.glsl",
  ...
  private void initializeBuffers() {
    ...
    vbo =
        new VertexBuffer.Builder(vao, GL_ARRAY_BUFFER)
  ...
  public void fillRect(int x, int y, int width, int height) {
    ...
    batchData[offset++] = Application.SCREEN_WIDTH; // width
    batchData[offset++] = Application.SCREEN_HEIGHT; // height
