...
public class GuiMouseCaptureManager {
  @Getter private static final GuiMouseCaptureManager instance = new GuiMouseCaptureManager();

  @Getter private GuiComponent capturedComponent = null;
  ...
  public GuiEventState dispatchToCapturedComponent(MouseEvent e) {
    //        boolean isCapturedEvent = (e instanceof MouseEvent.Dragged || e instanceof
    // MouseEvent.Released);
    if (capturedComponent != null) {
