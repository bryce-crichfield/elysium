...
public class NetworkingThread extends Thread {
  ...
  private final ConcurrentHashMap<String, IServiceCallback> pendingCallbacks =
  ...
  public Try<ServiceCall> callAsync(
      String serviceName, IMessage parameters, IServiceCallback callback) {
    ServiceCall call =
        new ServiceCall(serviceName, java.util.UUID.randomUUID().toString(), parameters);
