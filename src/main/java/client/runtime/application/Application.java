...
public class Application implements AutoCloseable {
  ...
  @Getter private final Keyboard keyboard = new Keyboard();

  @Getter private final Mouse mouse = new Mouse();

  @Getter private final Audio audio = new Audio(AudioStore.getInstance());

  @Delegate private final EffectsManager effects;

  @Delegate private final ApplicationSceneManager stateManager;
