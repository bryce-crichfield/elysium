...
public class Tile implements Serializable {
    ...
    public void onSpriteRender(SpriteRenderer renderer) {
        ...
        Sprite sprite = new Sprite(texture, 0, 0, GameContext.TILE_SIZE, GameContext.TILE_SIZE);
        int drawX = getX() * GameContext.TILE_SIZE;
        int drawY = getY() * GameContext.TILE_SIZE;
        renderer.drawSprite(drawX, drawY, GameContext.TILE_SIZE, GameContext.TILE_SIZE, sprite);
    }
}
