...
import core.transition.TransitionFactory;
...
public class GameStateManager {
    ...
    public GameStateManager(GameContext gameContext) {
        this.gameContext = gameContext;
    }

    // Method to capture the current screen as a source image
    public static FrameBuffer captureScreen(GameState state) {
        var frameBuffer = new FrameBuffer(GameContext.SCREEN_WIDTH, GameContext.SCREEN_HEIGHT);
    ...
    public void setState(GameStateFactory factory) {
        ...
        GameState newState = factory.create(gameContext);
    ...
    public void pushState(GameStateFactory factory, TransitionFactory transitionFactory) {
        ...
        target = factory.create(gameContext);
    ...
    public void render(Renderer renderer) {
        ...
        if (isTransitioning() && hasState()) {
            transition.render(renderer, GameContext.SCREEN_WIDTH, GameContext.SCREEN_HEIGHT);
            return;
        }
