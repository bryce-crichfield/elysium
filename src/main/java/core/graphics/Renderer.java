...
import core.graphics.font.FontRenderer;
import core.graphics.paint.Paint;
import core.graphics.paint.SolidColorPaint;
...
public class Renderer {
    ...
    @Getter
    private core.graphics.paint.Paint paint;
    ...
    public void fillRect(int x, int y, int width, int height) {
        ...
        if (paint instanceof core.graphics.paint.LinearGradientPaint gradient) {
    ...
    private void fillRectWithGradient(int x, int y, int width, int height, core.graphics.paint.LinearGradientPaint gradient) {
        pushTransform(Transform.fromScreenSpace(bufferWidth, bufferHeight));
